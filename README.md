...
🚀 Usage1. Run Ventilation Mapping (Python)To run the pipeline on the sample  dataset using default parameters:Bashpython main_gitventilation_ute.py --input_mat gitdata/img_Jj_2025_12_17.mat --output_dir gitdata/nex2_results
